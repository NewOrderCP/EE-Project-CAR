...
{										  					   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1RSTR = 0x00000000;
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR = 0x00000000; 
	  
  	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->AHBENR = 0x00000014;  
  	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR = 0x00000000; 
  	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR = 0x00000000;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR |= 0x00000001;     
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR &= 0xF8FF0000;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR &= 0xFEF6FFFF;     
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR &= 0xFFFBFFFF;     
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR &= 0xFF80FFFF;   
...
void Sys_Standby(void)
{
	((SCB_Type *) ((0xE000E000) + 0x0D00))->SCR|=1<<2;
...
void Sys_Soft_Reset(void)
{   
	((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR =0X05FA0000|(u32)0x04;	  
} 
...
void JTAG_Set(u8 mode)
{
	...
	temp=mode;
	temp<<=25;
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<0;     
	((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR&=0XF8FFFFFF; 
	((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR|=temp;       
} 
...
void Stm32_Clock_Init(u8 PLL)
{
	...
	MYRCC_DeInit();		  
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR|=0x00010000;  
	while(!(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR>>17));
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR=0X00000400; 
	PLL-=2;
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR|=PLL<<18;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR|=1<<16;	  
	((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->ACR|=0x32;	  

	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR|=0x01000000;  
	while(!(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR>>25));
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR|=0x00000002;
	while(temp!=0x02)     
	{   
		temp=((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR>>2;
		temp&=0x03;
	}    
}		    
