...
#line 2 "..\\User\\Usart.c"
#line 1 "D:\\keil\\ARM\\ARMCC\\include\\stdio.h"
...
#line 38 "D:\\keil\\ARM\\ARMCC\\include\\stdio.h"
...
#line 129 "D:\\keil\\ARM\\ARMCC\\include\\stdio.h"
...
#line 948 "D:\\keil\\ARM\\ARMCC\\include\\stdio.h"
...
void USART1_Puts(uint8_t * buffer);			
...
{      
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = (u8) ch;      
	while((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR&0X40)==0);
	return ch;
}
...
void USART1_Putc(uint8_t data)			
{
    ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = (uint8_t)data; 
	while((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR&0X40)==0); 
}
void USART1_Send_Enter(void)
{
...
void USART1_Puts(uint8_t * buffer)			
{
    while(*buffer)
    {
        ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR= *buffer++;
		while((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR&0X40)==0);
    }
}
...
{
	USART_ClearITPendingBit(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),USART1_IRQn);
	if(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR&(1<<5)) 
	{	

		GPIO_Write(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR);
	}		
}
